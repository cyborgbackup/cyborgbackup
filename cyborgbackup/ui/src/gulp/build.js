...
gulp.task('html', ['inject', 'partials'], function () {
  ...
  var jsVendorFilter = $.filter('bower_components/**/*.js', { restore: true, dot:true});
  var jsAppFilter = $.filter('src/**/*.js', { restore: true, dot:true});
  ...
  return gulp.src(path.join(conf.paths.tmp, '/serve/*.html'))
    ...
    .pipe(jsAppFilter)
    .pipe($.sourcemaps.init())
    .pipe(concat('node_modules/babel-polyfill/dist/polyfill.js'))
    .pipe(babel())
    .pipe($.sourcemaps.write('maps'))
